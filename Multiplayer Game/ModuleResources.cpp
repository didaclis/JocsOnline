...
bool ModuleResources::init()
{
	...
	loadTextureAsync("powerupNormal.png",	 &powerup01);
	loadTextureAsync("laserBig.png",		 &laserBig);
	loadTextureAsync("powerupBig.png",		 &powerupWeapon);
	...
	loadTextureAsync("invTex.png",			 &invTex);
#endif
